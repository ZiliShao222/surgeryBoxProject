...
class CameraThread(QThread):
    ...
    def run(self):
        ...
        try:
            # Prefer DirectShow on Windows for faster camera startup.
            ...
            try:
                ...
                self.cap.set(cv2.CAP_PROP_FPS, 60)  # Request 60 fps when supported.
            except Exception:
                pass
            ...
            while self.is_running:
                try:
                    ...
                    # Around 16 ms per loop keeps preview latency low for 60 fps cameras.
                    self.msleep(16)
    ...
    def stop(self):
        ...
        try:
            ...
            self.cleanup()
            # PySide6 wait() lacks a timeout in some builds, so poll with msleep.
...
class CameraManager(QWidget):
    ...
    def _detect_cameras(self):
        ...
        for i in range(10):  # Check first 10 indices
            # Prefer DirectShow on Windows when probing cameras.
